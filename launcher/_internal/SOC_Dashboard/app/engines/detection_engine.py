...
def detect_advanced_threats(df):
    ...
    print(f"[SOC] Logs received for detection: {len(df)}")
    print(f"[SOC] Rules loaded: {len(KEYWORD_RULES)}")
    ...
    print(f"[SOC] Threshold alerts: {len(threshold_alerts)}")
    ...
    print(f"[SOC] Total Matches: {total_matches}")
    print(f"[SOC] Final Alerts Generated: {len(alerts)}")
