...
class SOCService:
    ...
    def run_full_scan(self):
        ...
        try:
            ...
            logs_df=collect_all_logs(hours=24*30)
    ...
    def refresh_alerts(self):
        ...
        logs_df=collect_all_logs(hours=1)

        print(
            f"[+] New logs collected: {len(logs_df)}"
        )
        ...
        alerts=detect_advanced_threats(
            logs_df
        )

        print(
            f"[+] New alerts generated: {len(alerts)}"
        )
