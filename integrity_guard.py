...
SKIP_DIRS = {
    ...
    "dist", "build"          # PyInstaller output dirs
}

SKIP_FILES = {
    "integrity_guard.py",   # guard itself excluded
    "build_exe.py",
    "persistent_seen.db",   # cross-session dedup DB, changes every scan
}

# Also skip the entire database/ folder from hashing
# (session DBs change every launch)
# database/ already in SKIP_DIRS above
